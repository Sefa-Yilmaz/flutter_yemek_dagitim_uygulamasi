...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButton = TextButton.styleFrom(
      ...
      minimumSize: Size(width == null ? Boyutlar.screenWidth : width!, height != null ? height! : 50),
    ...
    return Center(
      child: SizedBox(
        width: width ?? Boyutlar.screenWidth,
        height: height ?? 50,
        child: TextButton(
          onPressed: onPressed,
          style: _flatButton,
          child: Row(
            ...
            children: [
              icon != null
                  ? Padding(
                      padding: EdgeInsets.only(right: Boyutlar.width10 / 2),
              ...
              Text(
                buttonText,
                style: TextStyle(
                  fontSize: fontSize != null ? fontSize : Boyutlar.font16,
