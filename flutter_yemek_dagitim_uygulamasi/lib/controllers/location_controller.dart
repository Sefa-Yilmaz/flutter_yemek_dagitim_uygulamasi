...
import 'package:flutter_yemek_dagitim_uygulamasi/data/api/api_checker.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  /* Future<void> getCurrentLocation(bool fromAddress, {required GoogleMapController mapController, LatLng? defaultLatLng, bool notify = true}) async {
    _loading = true;
    if (notify) {
      update();
    }
  ...
  Future<String> getAddressfromGeocode(LatLng latlng) async {
    ...
    if (response.body['status'] == 'OK') {
      ...
      print('errror getting the google api');
    }
    update();
    return _address;
  }
